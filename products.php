...
<head>
    ...
    <title><?= $lang['page_title_products'] ?></title>
...
<body>
    ...
    <div class="header">
        ...
        <h1 class="header-title" id="categoryName"><?= $lang['header_products'] ?></h1>
    </div>

    <div class="search">
        <span class="search-icon">🔍</span>
        <input type="text" id="searchInput" placeholder="<?= $lang['search_products'] ?>">
        <span class="clear-icon hidden" id="clearSearch">✕</span>
    </div>

    <!-- Skeleton -->
    <div class="products-grid" id="skeleton-products">
    ...
    <div class="products-grid hidden" id="real-products">
    </div>

    <div id="telegram_user_id" data-id="<?= $user_id ?>"></div>
    <div id="user_lang" data-lang="<?= $lang_code ?>"></div>
    <div id="category_id" data-id="<?= $category_id ?>"></div>
    ...
    <script src="js/products.js?v=<?= $version ?>"></script>
</body>
</html>
