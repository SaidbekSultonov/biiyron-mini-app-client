...
<head>
    ...
    <title><?= $lang['page_title_home'] ?></title>
...
<body>
    ...
    <div class="slider-container">
        <div class="slider" id="slider">
            <div class="slide slide-1"><?= $lang['slide_1'] ?></div>
            <div class="slide slide-2"><?= $lang['slide_2'] ?></div>
            <div class="slide slide-3"><?= $lang['slide_3'] ?></div>
        </div>
    ...
    <div class="section-title">
        <?= $lang['lang_categories'] ?? 'Kategoriyalar' ?>
    </div>
    
    <div class="categories" id="skeleton-categories">
    ...
    <div class="categories hidden" id="real-categories">
    </div>
    ...
    <div class="bottom-nav">
        <a href="index.php?user_id=<?= $user_id ?>" class="nav-item active">
            <div class="nav-icon">
