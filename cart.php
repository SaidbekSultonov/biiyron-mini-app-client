...
<head>
    ...
    <title><?= $lang['page_title_cart'] ?></title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="css/cart.css?v=<?= $version ?>">
...
<body>
    ...
    <div class="header">
        ...
        <h1 class="header-title"><?= $lang['header_cart'] ?></h1>
    </div>

    <!-- Skeleton -->
    <div id="skeleton-cart">
    ...
    <div class="empty-cart" id="emptyCart" style="display: none;">
        ...
        <div class="empty-text"><?= $lang['cart_empty_text'] ?></div>
        <button class="btn-shop" onclick="window.location='index.php?user_id=<?= $user_id ?>'"><?= $lang['btn_shop'] ?></button>
    </div>

    <!-- Shops selection -->
    <div class="shops-section" id="shopsSection" style="display: none;">
    </div>
    ...
    <div class="bottom-nav">
        ...
        <div class="nav-item cart active">
            <div class="nav-icon">
    ...
    <script src="js/cart.js?v=<?= $version ?>"></script>
</body>
</html>
